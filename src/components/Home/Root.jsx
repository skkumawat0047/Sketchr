...
const FEATURES = [
  {
    ...
    text: "Work together with your team on the same board. Watch cursors move and shapes appear live — like everyone's sitting at the same table.",
    color: COLORS.teal,
  },
  {
    icon: Shapes,
    title: "Rich drawing tools",
    text: "From perfect shapes to freehand scribbles and sticky notes — bring exactly what's in your head onto the board, without any friction.",
    color: COLORS.coral,
  },
  {
    icon: InfinityIcon,
    title: "Infinite canvas",
    text: "No more running out of space. Pan, zoom, and stretch your ideas as far as they need to go — the board never ends.",
    color: COLORS.yellow,
  },
  {
    icon: Zap,
    title: "Blazing fast",
    text: "No lag, just flow. Even with thousands of shapes, the board stays as smooth as it was on the very first stroke.",
    color: "#B7A6FF",
  },
  {
    icon: Cloud,
    title: "Auto-saved, always",
    text: "Every stroke is saved to the cloud instantly. Close the tab, switch laptops — your board will be exactly as you left it.",
    color: "#7FD1C4",
  },
  {
    icon: Share2,
    title: "One-click sharing",
    text: "Create a link, send it, and you're working. Passwords and permissions are entirely in your control.",
    color: "#FFB4A2",
  },
];
...
const STEPS = [
  {
    ...
    text: "A blank canvas ready in one click — no setup, no forced templates.",
  },
  {
    n: "02",
    title: "Invite your team",
    text: "Share a link and everyone can start drawing, planning, and brainstorming together.",
  },
  {
    n: "03",
    title: "Bring ideas to life",
    text: "From a rough scribble to a polished diagram — all in one place, in real time.",
  },
];
    ...
    <div className="page">
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .nav-links a:hover { color:skyblue; font:bold}
      ...
      <nav className="nav">
        ...
        <div className="nav-links">
          <NavLink to="/features" onClick={(e) => handleAnchorClick(e, "features")}>Features</NavLink>
          <NavLink to="/how" onClick={(e) => handleAnchorClick(e, "how")}>How to Use</NavLink>
          <NavLink to="/Login" onClick={onGetStarted} className="nav-cta">Log in</NavLink>
        </div>
      </nav>
      ...
      <section className="why">
        ...
        <p>
          ...
          simple, yet powerful. That's why teams switch to it and never go back.
        </p>
